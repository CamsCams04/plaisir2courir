...
document.getElementById("searchInput").addEventListener("input", (e) => {
    const searchQuery = e.target.value.toLowerCase(); // Récupérer la valeur de recherche
    filterAndDisplayUsers(searchQuery);
});

function filterAndDisplayUsers(searchQuery) {
    const table_admin = document.querySelector("#table_admin tbody");
    table_admin.innerHTML = ""; // Réinitialiser la table
    ...
    // Afficher les utilisateurs filtrés dans la table
